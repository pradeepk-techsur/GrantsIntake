/**
 * Client-side budget types mirroring server-side src/types/budget.ts
 * Corresponds to budgets and budget_line_items tables (migration 013_budget_attachments_schema).
 */
