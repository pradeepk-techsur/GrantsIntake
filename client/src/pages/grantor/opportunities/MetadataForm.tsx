  ...
  return (
    <form data-testid="metadata-form" noValidate>
      ...
      {saveStatus === 'saved' && (
        ...
        >
          <div >
            <p className="gf-alert__text">Changes saved</p>
          </div>
        </div>
      )}
      ...
      <fieldset >
        ...
        {/* title */}
        <div className={`gf-form-group${getFieldError('title') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-title">
            Opportunity Title <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('title') && (
            <span className="gf-error-msg" role="alert">{getFieldError('title')}</span>
          )}
          <input
            id="opp-title"
            name="title"
            className={`gf-input${getFieldError('title') ? ' gf-input--error' : ''}`}
            type="text"
            maxLength={250}
            required
            value={fields.title}
        ...
        {/* opportunity_number */}
        <div className={`gf-form-group${getFieldError('opportunity_number') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-number">
            Opportunity Number <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('opportunity_number') && (
            <span className="gf-error-msg" role="alert">{getFieldError('opportunity_number')}</span>
          )}
          <input
            id="opp-number"
            name="opportunity_number"
            className={`gf-input${getFieldError('opportunity_number') ? ' gf-input--error' : ''}`}
            type="text"
            maxLength={100}
            required
        ...
        {/* funding_source */}
        <div className={`gf-form-group${getFieldError('funding_source') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-funding-source">
            Funding Source <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('funding_source') && (
            <span className="gf-error-msg" role="alert">{getFieldError('funding_source')}</span>
          )}
          <input
            id="opp-funding-source"
            name="funding_source"
            className={`gf-input${getFieldError('funding_source') ? ' gf-input--error' : ''}`}
            type="text"
            maxLength={250}
            required
        ...
        {/* announcement_type */}
        <div className={`gf-form-group${getFieldError('announcement_type') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-announcement-type">
            Announcement Type <abbr title="required" className="gf-hint">*</abbr>
          </label>
          <select
        ...
        {/* program_area */}
        <div className={`gf-form-group${getFieldError('program_area') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-program-area">
            Program Area <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('program_area') && (
            <span className="gf-error-msg" role="alert">{getFieldError('program_area')}</span>
          )}
          <input
            id="opp-program-area"
            name="program_area"
            className={`gf-input${getFieldError('program_area') ? ' gf-input--error' : ''}`}
            type="text"
            maxLength={100}
            required
      ...
      <fieldset  style={{ marginTop: '2rem' }}>
        ...
        {/* funding_amount_max */}
        <div className={`gf-form-group${getFieldError('funding_amount_max') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-amount-max">
            Maximum Award Amount <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('funding_amount_max') && (
            <span className="gf-error-msg" role="alert">{getFieldError('funding_amount_max')}</span>
          )}
          <input
            id="opp-amount-max"
            name="funding_amount_max"
            className={`gf-input${getFieldError('funding_amount_max') ? ' gf-input--error' : ''}`}
            type="number"
            min={0}
            required
        ...
        {/* funding_amount_min */}
        <div className={`gf-form-group${getFieldError('funding_amount_min') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-amount-min">
            Minimum Award Amount (optional)
          </label>
          {getFieldError('funding_amount_min') && (
            <span className="gf-error-msg" role="alert" data-testid="funding-min-error">{getFieldError('funding_amount_min')}</span>
          )}
          <input
            id="opp-amount-min"
            name="funding_amount_min"
            className={`gf-input${getFieldError('funding_amount_min') ? ' gf-input--error' : ''}`}
            type="number"
            min={0}
        ...
        <div className="gf-form-group">
          <label className="gf-label" htmlFor="opp-total-funding">
        ...
        <div className="gf-form-group">
          <label className="gf-label" htmlFor="opp-awards-min">
        ...
        <div className="gf-form-group">
          <label className="gf-label" htmlFor="opp-awards-max">
        ...
        {isFederal && (
          <div className={`gf-form-group${getFieldError('assistance_listing_number') ? ' gf-form-group' : ''}`}>
            <label className="gf-label" htmlFor="opp-aln">
              Assistance Listing Number{' '}
              <abbr title="required" className="gf-hint">*</abbr>
              <span className="gf-hint"> (Required for federal funding — format: XX.XXX)</span>
            </label>
            {getFieldError('assistance_listing_number') && (
              <span className="gf-error-msg" role="alert" data-testid="aln-error">
                {getFieldError('assistance_listing_number')}
              </span>
            )}
            <input
              ...
              className={`gf-input${getFieldError('assistance_listing_number') ? ' gf-input--error' : ''}`}
              type="text"
              maxLength={10}
      ...
      <fieldset  style={{ marginTop: '2rem' }}>
        <legend >Narrative Fields</legend>

        {/* executive_summary */}
        <div className={`gf-form-group${getFieldError('executive_summary') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-exec-summary">
            Executive Summary <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('executive_summary') && (
            <span className="gf-error-msg" role="alert">{getFieldError('executive_summary')}</span>
          )}
          <textarea
            id="opp-exec-summary"
            name="executive_summary"
            className={`gf-textarea${getFieldError('executive_summary') ? ' gf-input--error' : ''}`}
            required
            rows={5}
        ...
        {/* eligibility_summary */}
        <div
          className={`gf-form-group${getFieldError('eligibility_summary') ? ' gf-form-group' : ''}`}
          style={{ marginTop: '1.5rem' }}
        >
          <label className="gf-label" htmlFor="opp-eligibility-summary">
            Eligibility Summary <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('eligibility_summary') && (
            <span className="gf-error-msg" role="alert">{getFieldError('eligibility_summary')}</span>
          )}
          <textarea
            id="opp-eligibility-summary"
            name="eligibility_summary"
            className={`gf-textarea${getFieldError('eligibility_summary') ? ' gf-input--error' : ''}`}
            required
            rows={5}
      ...
      <fieldset  style={{ marginTop: '2rem' }}>
        ...
        {/* contact_name */}
        <div className={`gf-form-group${getFieldError('contact_name') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-contact-name">
            Contact Name <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('contact_name') && (
            <span className="gf-error-msg" role="alert">{getFieldError('contact_name')}</span>
          )}
          <input
            id="opp-contact-name"
            name="contact_name"
            className={`gf-input${getFieldError('contact_name') ? ' gf-input--error' : ''}`}
            type="text"
            maxLength={250}
            required
        ...
        {/* contact_email */}
        <div className={`gf-form-group${getFieldError('contact_email') ? ' gf-form-group' : ''}`}>
          <label className="gf-label" htmlFor="opp-contact-email">
            Contact Email <abbr title="required" className="gf-hint">*</abbr>
          </label>
          {getFieldError('contact_email') && (
            <span className="gf-error-msg" role="alert" data-testid="contact-email-error">
              {getFieldError('contact_email')}
            </span>
          )}
          <input
            ...
            name="contact_email"
            className={`gf-input${getFieldError('contact_email') ? ' gf-input--error' : ''}`}
            type="email"
            maxLength={320}
            required
        ...
        {/* contact_phone */}
        <div className="gf-form-group">
          <label className="gf-label" htmlFor="opp-contact-phone">
        ...
        {/* contact_title */}
        <div className="gf-form-group">
          <label className="gf-label" htmlFor="opp-contact-title">
